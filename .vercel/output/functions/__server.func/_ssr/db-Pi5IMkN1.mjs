//#region node_modules/.nitro/vite/services/ssr/assets/db-Pi5IMkN1.js
...
var _0002_favorites_default = "create table if not exists favorites (\n  user_id text not null,\n  software_id text not null,\n  created_at timestamptz not null default now(),\n  primary key (user_id, software_id)\n);\ncreate index if not exists favorites_user_id_idx on favorites (user_id);\n";
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_favorites.sql": _0002_favorites_default
		});
