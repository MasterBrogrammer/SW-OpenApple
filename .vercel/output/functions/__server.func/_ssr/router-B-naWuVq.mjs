...
import { n as auth } from "./server-D3zjReY0.mjs";
import { r as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-B-naWuVq.js
...
var styles_default = "/assets/styles-D_EraSxq.css";
var APP_NAME = "OpenApple";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A browser Apple IIe. Raw video output and a library of free, open-source software."
			}
		],
		links: [
			{
...
var $$splitComponentImporter$1 = () => import("./routes-Dw7I7NGO.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-DoQcpL3N.mjs");
