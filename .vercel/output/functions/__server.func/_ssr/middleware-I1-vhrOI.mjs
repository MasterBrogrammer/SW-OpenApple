...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-I1-vhrOI.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { assertSameSiteRequest } = await import("./isolation.server-Dm0wnchh.mjs");
	const { requireUserId } = await import("./verify.server-CHp7QH5w.mjs");
