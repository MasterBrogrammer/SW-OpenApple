...
export default class DiskII implements Card<State>, MassStorage<NibbleFormat> {
    ...
    initWorker() {
        // Main-thread disk decode only. The webpack worker bundle is not
        // part of this Vite app; createDisk() on the UI thread is fine.
        return;
    }
    ...
    private insertDisk(driveNo: DriveNumber, disk: FloppyDisk) {
        ...
        this.drives[driveNo].track = 0;
        this.drives[driveNo].phase = 0;
